...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        #     # of xblocks
        # )
        ('no_overrides', 1, True, False): (35, 0, 6, 1),
        ('no_overrides', 2, True, False): (41, 0, 6, 1),
        ('no_overrides', 3, True, False): (51, 0, 6, 1),
        ('ccx', 1, True, False): (35, 0, 6, 1),
        ('ccx', 2, True, False): (41, 0, 6, 1),
        ('ccx', 3, True, False): (51, 0, 6, 1),
        ('ccx', 1, True, True): (48, 0, 6, 1),
        ('ccx', 2, True, True): (41, 0, 6, 1),
        ('ccx', 3, True, True): (51, 0, 6, 1),
        ('no_overrides', 1, False, False): (35, 0, 6, 1),
        ('no_overrides', 2, False, False): (41, 0, 6, 1),
        ('no_overrides', 3, False, False): (51, 0, 6, 1),
        ('ccx', 1, False, False): (35, 0, 6, 1),
        ('ccx', 2, False, False): (41, 0, 6, 1),
        ('ccx', 3, False, False): (51, 0, 6, 1),
        ('ccx', 1, False, True): (48, 0, 6, 1),
        ('ccx', 2, False, True): (41, 0, 6, 1),
        ('ccx', 3, False, True): (51, 0, 6, 1),
    }
...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ('no_overrides', 1, True, False): (35, 0, 4, 1),
        ('no_overrides', 2, True, False): (41, 0, 19, 1),
        ('no_overrides', 3, True, False): (51, 0, 84, 1),
        ('ccx', 1, True, False): (35, 0, 4, 1),
        ('ccx', 2, True, False): (41, 0, 19, 1),
        ('ccx', 3, True, False): (51, 0, 84, 1),
        ('ccx', 1, True, True): (36, 0, 5, 6),
        ('ccx', 2, True, True): (42, 0, 20, 47),
        ('ccx', 3, True, True): (52, 0, 85, 202),
        ('no_overrides', 1, False, False): (35, 0, 4, 1),
        ('no_overrides', 2, False, False): (41, 0, 19, 1),
        ('no_overrides', 3, False, False): (51, 0, 84, 1),
        ('ccx', 1, False, False): (35, 0, 4, 1),
        ('ccx', 2, False, False): (41, 0, 19, 1),
        ('ccx', 3, False, False): (51, 0, 84, 1),
